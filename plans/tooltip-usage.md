...
- [x] 4. Verification pass: serve locally, check both records' pages render, links relative, badges in sync, `data-l` on every td, no `<script>`/scoped `<style>`, wide + narrow viewport behaviour
